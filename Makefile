...
lepus_msc_recovery_config:	unconfig
	@echo "#define CONFIG_MSC_U_BOOT" > $(obj)include/config.h
	@echo "#define CONFIG_JZ_RECOVERY">> $(obj)include/config.h
	#@echo "#define CONFIG_SDRAM_SDRAM" >> $(obj)include/config.h
...
pallas_msc_recovery_config:	unconfig
	@echo "#define CONFIG_MSC_U_BOOT" > $(obj)include/config.h
	@echo "#define CONFIG_JZ_RECOVERY">> $(obj)include/config.h
	@echo "#define CONFIG_SDRAM_DDR2" >> $(obj)include/config.h
	#@echo "Compile MSC boot image for lepus60b"
	@./mkconfig -a pallas mips mips pallas
	@echo "TEXT_BASE = 0x80100200" > $(obj)board/lepus60b/config.tmp
	@echo "CONFIG_MSC_U_BOOT = y" >> $(obj)include/config.mk
	@echo "CONFIG_CPU_TYPE = 4760b" >> $(obj)include/config.mk
	@echo "CONFIG_USE_MDDR = n" >> $(obj)include/config.mk
...
RetroFW_1A_defconfig:   unconfig
	@echo "#define CONFIG_MSC_U_BOOT" > $(obj)include/config.h
	@echo "#define CONFIG_JZ_RECOVERY">> $(obj)include/config.h
	@echo "#define CONFIG_SDRAM_DDR2" >> $(obj)include/config.h
	@echo "#define CONFIG_SDRAM_MDDR" >> $(obj)include/config.h
	@echo "#define CONFIG_LCD" >> $(obj)include/config.h
	@echo "#define CONFIG_JZ4760_LCD_RG_V10" >> $(obj)include/config.h
	@echo "Compile MSC boot image for a RetroFW 1.0 screen with a JZ4760 processor"
	@./mkconfig -a lepus mips mips lepus
	@echo "TEXT_BASE = 0x80100200" > $(obj)board/lepus/config.tmp
	@echo "CONFIG_MSC_U_BOOT = y" >> $(obj)include/config.mk
	@echo "CONFIG_CPU_TYPE = 4760" >> $(obj)include/config.mk
...
RetroFW_1B_defconfig:   unconfig
	@echo "#define CONFIG_MSC_U_BOOT" > $(obj)include/config.h
	@echo "#define CONFIG_JZ_RECOVERY">> $(obj)include/config.h
	@echo "#define CONFIG_SDRAM_DDR2" >> $(obj)include/config.h
	@echo "#define CONFIG_LCD" >> $(obj)include/config.h
	@echo "#define CONFIG_JZ4760_LCD_RG_V10" >> $(obj)include/config.h
	@echo "Compile MSC boot image for a RetroFW 1.0 screen with a JZ4760B processor"
	@./mkconfig -a lepus60b mips mips lepus60b
	@echo "TEXT_BASE = 0x80100200" > $(obj)board/lepus60b/config.tmp
	@echo "CONFIG_MSC_U_BOOT = y" >> $(obj)include/config.mk
	@echo "CONFIG_CPU_TYPE = 4760b" >> $(obj)include/config.mk
...
RetroFW_2A_defconfig:   unconfig
	@echo "#define CONFIG_MSC_U_BOOT" > $(obj)include/config.h
	@echo "#define CONFIG_JZ_RECOVERY">> $(obj)include/config.h
	@echo "#define CONFIG_SDRAM_DDR2" >> $(obj)include/config.h
	@echo "#define CONFIG_SDRAM_MDDR" >> $(obj)include/config.h
	@echo "#define CONFIG_LCD" >> $(obj)include/config.h
	@echo "#define CONFIG_JZ4760_LCD_RG_V21" >> $(obj)include/config.h
...
RetroFW_2B_defconfig:   unconfig
	@echo "#define CONFIG_MSC_U_BOOT" > $(obj)include/config.h
	@echo "#define CONFIG_JZ_RECOVERY">> $(obj)include/config.h
	@echo "#define CONFIG_SDRAM_DDR2" >> $(obj)include/config.h
	@echo "#define CONFIG_LCD" >> $(obj)include/config.h
	@echo "#define CONFIG_JZ4760_LCD_RG_V21" >> $(obj)include/config.h
	@echo "Compile MSC boot image for a RetroFW 2.1 screen with a JZ4760B processor"
	@./mkconfig -a lepus60b mips mips lepus60b
	@echo "TEXT_BASE = 0x80100200" > $(obj)board/lepus60b/config.tmp
	@echo "CONFIG_MSC_U_BOOT = y" >> $(obj)include/config.mk
	@echo "CONFIG_CPU_TYPE = 4760b" >> $(obj)include/config.mk
...
RetroFW_3B_defconfig:   unconfig
	@echo "#define CONFIG_MSC_U_BOOT" > $(obj)include/config.h
	@echo "#define CONFIG_JZ_RECOVERY">> $(obj)include/config.h
	@echo "#define CONFIG_SDRAM_DDR2" >> $(obj)include/config.h
	@echo "#define CONFIG_LCD" >> $(obj)include/config.h
	@echo "#define CONFIG_JZ4760_LCD_RG_V30" >> $(obj)include/config.h
	@echo "Compile MSC boot image for a RetroFW 3.0 screen with a JZ4760B processor"
	@./mkconfig -a lepus60b mips mips lepus60b
	@echo "TEXT_BASE = 0x80100200" > $(obj)board/lepus60b/config.tmp
	@echo "CONFIG_MSC_U_BOOT = y" >> $(obj)include/config.mk
	@echo "CONFIG_CPU_TYPE = 4760b" >> $(obj)include/config.mk
...
RetroFW_5B_defconfig:   unconfig
	@echo "#define CONFIG_MSC_U_BOOT" > $(obj)include/config.h
	@echo "#define CONFIG_JZ_RECOVERY">> $(obj)include/config.h
	@echo "#define CONFIG_SDRAM_DDR2" >> $(obj)include/config.h
	@echo "#define CONFIG_LCD" >> $(obj)include/config.h
	@echo "#define CONFIG_JZ4760_LCD_RG_IPS" >> $(obj)include/config.h
	@echo "Compile MSC boot image for a RetroFW 5.0 (IPS) screen with a JZ4760B processor"
	@./mkconfig -a lepus60b mips mips lepus60b
	@echo "TEXT_BASE = 0x80100200" > $(obj)board/lepus60b/config.tmp
	@echo "CONFIG_MSC_U_BOOT = y" >> $(obj)include/config.mk
	@echo "CONFIG_CPU_TYPE = 4760b" >> $(obj)include/config.mk
...
clean:
	find $(OBJTREE) -type f \
		...
		| xargs rm -f
	rm -rf git_version.h
	rm -rf $(obj)examples/hello_world $(obj)examples/timer \
	      $(obj)examples/eepro100_eeprom $(obj)examples/sched \
	      $(obj)examples/mem_to_mem_idma2intr $(obj)examples/82559_eeprom \
	      $(obj)examples/smc91111_eeprom $(obj)examples/interrupt \
	      $(obj)examples/test_burst
	rm -rf $(obj)tools/img2srec $(obj)tools/mkimage $(obj)tools/envcrc \
		$(obj)tools/gen_eth_addr
	rm -rf $(obj)tools/mpc86x_clk $(obj)tools/ncb
	rm -rf $(obj)tools/easylogo/easylogo $(obj)tools/bmp_logo
	rm -rf $(obj)tools/gdb/astest $(obj)tools/gdb/gdbcont $(obj)tools/gdb/gdbsend
	rm -rf $(obj)tools/env/fw_printenv $(obj)tools/env/fw_setenv
	rm -rf $(obj)board/cray/L1/bootscript.c $(obj)board/cray/L1/bootscript.image
	rm -rf $(obj)board/netstar/eeprom $(obj)board/netstar/crcek $(obj)board/netstar/crcit
	rm -rf $(obj)board/netstar/*.srec $(obj)board/netstar/*.bin
	rm -rf $(obj)board/trab/trab_fkt $(obj)board/voiceblue/eeprom
	rm -rf $(obj)board/integratorap/u-boot.lds $(obj)board/integratorcp/u-boot.lds
	rm -rf $(obj)include/bmp_logo.h
	rm -rf $(obj)nand_spl/u-boot-spl $(obj)nand_spl/u-boot-spl.map
	rm -rf $(obj)msc_spl/u-boot-spl $(obj)msc_spl/u-boot-spl.map
	rm -rf $(obj)spi_spl/u-boot-spl $(obj)spi_spl/u-boot-spl.map
	if [ ! "$(BOARDDIR)" = "" ]; then \
...
clobber:	clean
	find $(OBJTREE) -type f \( -name .depend \
		...
		-print0 \
		| xargs -0 rm -rf
	rm -rf $(OBJS) $(obj)*.bak $(obj)ctags $(obj)etags $(obj)TAGS $(obj)include/version_autogenerated.h
	rm -rf $(obj)*.*~
	rm -rf $(obj)u-boot $(obj)u-boot.map $(obj)u-boot.hex $(ALL)
	rm -rf $(obj)tools/crc32.c $(obj)tools/environment.c $(obj)tools/env/crc32.c
	rm -rf $(obj)tools/inca-swap-bytes $(obj)cpu/mpc824x/bedbug_603e.c
	rm -rf $(obj)include/asm/proc $(obj)include/asm/arch $(obj)include/asm
#	[ ! -d $(OBJTREE)/nand_spl ] || find $(obj)nand_spl -lname "*" -print | xargs rm -rf
